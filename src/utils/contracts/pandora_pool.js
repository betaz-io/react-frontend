const contract = {
  testnet: {
    CONTRACT_ADDRESS: "5GL17JhATXoPHE7ZNmftzbFyFABgfC8K9vztzCLJq4fgNqU4",
    CONTRACT_ABI: {
      source: {
      ...
      spec: {
        ...
        messages: [
          ...
          },
          {
            ...
            default: false,
            docs: [],
            label: "PandoraPoolTraits::update_nft_info",
            mutates: true,
            payable: false,
            returnType: {
              displayName: ["ink", "MessageResult"],
  ...
  mainnet: {
    CONTRACT_ADDRESS: "5H7azQyF4jNVwynYi3mv8qmQ3Cdq6wHNqoyL5DFTb7j7emaP",
    CONTRACT_ABI: {
      source: {
        hash: "0x8ed4814727da2acdb32b0942ae52703d6b38435b8854f0fbabdbdadc89ea366f",
        language: "ink! 4.3.0",
        compiler: "rustc 1.75.0-nightly",
        build_info: {
          build_mode: "Debug",
